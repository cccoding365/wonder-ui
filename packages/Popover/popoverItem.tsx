    ...
    >
      <div
        className={classNames(
          'wonder_popover',
          isHidden ? 'wonder_popover_hidden' : ''
        )}
        ref={popoverRef}
        style={popoverStyle}
      ...
      >
        <div
          className={classNames(
            'wonder_popover_content',
            `wonder_popover_content_${placement}`
          )}
        >
          <div
            className={classNames(
              'wonder_popover_arrow',
              `wonder_popover_arrow_${placement}`
            )}
            style={arrowStyle}
          />
          <div className="wonder_popover_inner">
            <div className="wonder_popover_title">{title}</div>
            <div className="wonder_popover_inner_content">{content}</div>
          </div>
        </div>
      </div>
    </CSSTransition>
