...
function TooltipEl(props: TooltipEleProps): JSX.Element {
  ...
  const arrowClass = classNames({
    'wonder_tooltip-arrow': true,
    [`wonder_tooltip-arrow_${align}`]: true,
  })
  useEffect(() => {
    if (elWidth > 0) {
      if (align === 'top') {
  ...
  return (
    <CSSTransition
      ...
      unmountOnExit
    >
      <div className="wonder_tooltip_position" style={style} ref={divRef}>
        <div className="wonder_tooltip_content" style={{ background: color }}>
          {content}
